...
module.exports = {
        ...
        use: [
          {
            loader: "url-loader",
            options: {
              limit: 10 * 1024, // 只要文件不超过 10KB，则使用 base64 编码，否则，交给 file-loader 进行处理
  ...
  plugins: [
    ...
    new CopyPlugin({
      // 将 public 目录中的所有文件复制到 输出目录 的根目录
      patterns: [
        {
    ...
    new MiniCssExtractPlugin({
      ...
      chunkFilename: "css/common.[hash:5].css" // 针对公共样式（被分离到了一个单独的文件中）的文件名
    }),
  ],
};
